...
package com.wl.libs.widget.swipyrefreshlayout;
 ...
 * <p>
 * This dialog_list should be made the parent of the view that will be refreshed as a
 * result of the gesture and can only support one direct child. This view will
 * also be made the target of the gesture and will be forced to match both the
 * width and the height supplied in this dialog_list. The SwipeRefreshLayout does not
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    /**
     * @return Whether it is possible for the child view of this dialog_list to
